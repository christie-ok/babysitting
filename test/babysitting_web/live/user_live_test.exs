defmodule BabysittingWeb.UserLiveTest do
  ...
  @invalid_attrs %{address: nil, city: nil, first_name: nil, last_name: nil, state: nil, zip: nil}

  defp create_user(_) do
    user = insert(:user, address: "221B Baker Street")
    %{user: user}
  end
