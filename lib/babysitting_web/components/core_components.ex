defmodule BabysittingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BabysittingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BabysittingWeb.Gettext, "errors", msg, opts)
    end
  end
